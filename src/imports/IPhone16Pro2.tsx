import imgIPhone16Pro2 from "figma:asset/5f5f32831b3953cae1975023de869ad257008f45.png";
...
export default function IPhone16Pro() {
  return (
    <div className="relative size-full" data-name="iPhone 16 Pro - 2">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-full left-[-6.52%] max-w-none top-0 w-[124.24%]" src={imgIPhone16Pro2} />
      </div>
      ...
      <div className="absolute h-[285px] left-[17px] top-[514px] w-[367.9px]" data-name="image 21">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
